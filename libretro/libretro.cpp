...
static const byte pvm_style_fbx_palette[64][3] =
{
  {0x69,0x69,0x64}, {0x00,0x17,0x74}, {0x28,0x00,0x7D}, {0x3E,0x00,0x6D},
  {0x56,0x00,0x57}, {0x5E,0x00,0x13}, {0x53,0x1A,0x00}, {0x3B,0x24,0x00},
  {0x2A,0x30,0x00}, {0x14,0x3A,0x00}, {0x00,0x3F,0x00}, {0x00,0x3B,0x1E},
  {0x00,0x30,0x50}, {0x00,0x00,0x00}, {0x00,0x00,0x00}, {0x00,0x00,0x00},
  {0xB9,0xB9,0xB4}, {0x14,0x53,0xB9}, {0x4D,0x2C,0xDA}, {0x7A,0x1E,0xC8},
  ...
  {0xFF,0xFF,0xFF}, {0x69,0xA8,0xFF}, {0x9A,0x96,0xFF}, {0xC2,0x8A,0xFA},
  {0xEA,0x7D,0xFA}, {0xF3,0x87,0xB4}, {0xF1,0x98,0x6C}, {0xE6,0xB3,0x27},
  {0xD7,0xC8,0x05}, {0x90,0xDF,0x07}, {0x64,0xE5,0x3C}, {0x45,0xE2,0x7D},
  {0x48,0xD5,0xD9}, {0x4B,0x4B,0x46}, {0x00,0x00,0x00}, {0x00,0x00,0x00},
  {0xFF,0xFF,0xFF}, {0xD2,0xEA,0xFF}, {0xE2,0xE2,0xFF}, {0xF2,0xD8,0xFF},
  {0xF8,0xD2,0xFF}, {0xF8,0xD9,0xEA}, {0xFA,0xDE,0xB9}, {0xF9,0xE8,0x9B},
  {0xF3,0xF2,0x8C}, {0xD3,0xFA,0x91}, {0xB8,0xFC,0xA8}, {0xAE,0xFA,0xCA},
  {0xCA,0xF3,0xF3}, {0xBE,0xBE,0xB9}, {0x00,0x00,0x00}, {0x00,0x00,0x00}
};

static const byte original_hardware_fbx_palette[64][3] =
{
  {0x6A,0x6D,0x6A}, {0x00,0x12,0x7D}, {0x18,0x00,0x82}, {0x3B,0x00,0x7D},
  {0x56,0x00,0x5D}, {0x5A,0x00,0x18}, {0x4F,0x0D,0x00}, {0x38,0x1E,0x00},
  {0x20,0x31,0x00}, {0x00,0x3D,0x00}, {0x00,0x40,0x00}, {0x00,0x3B,0x1E},
  {0x00,0x2E,0x55}, {0x00,0x00,0x00}, {0x00,0x00,0x00}, {0x00,0x00,0x00},
  {0xB9,0xBC,0xB9}, {0x19,0x4E,0xC8}, {0x47,0x2F,0xE3}, {0x75,0x1F,0xD7},
  {0x93,0x1E,0xAD}, {0x9E,0x24,0x5E}, {0x96,0x38,0x00}, {0x7B,0x50,0x00},
  {0x5B,0x67,0x00}, {0x26,0x7A,0x00}, {0x00,0x7F,0x00}, {0x00,0x78,0x42},
  {0x00,0x6E,0x8A}, {0x00,0x00,0x00}, {0x00,0x00,0x00}, {0x00,0x00,0x00},
  {0xFF,0xFF,0xFF}, {0x69,0xAE,0xFF}, {0x97,0x98,0xFF}, {0xB6,0x87,0xFF},
  {0xE2,0x78,0xFF}, {0xF2,0x79,0xC7}, {0xF5,0x8F,0x6F}, {0xDD,0xA9,0x32},
  {0xBC,0xB7,0x0D}, {0x88,0xD0,0x15}, {0x60,0xDB,0x49}, {0x4F,0xD6,0x87},
  {0x50,0xCA,0xCE}, {0x51,0x54,0x51}, {0x00,0x00,0x00}, {0x00,0x00,0x00},
  {0xFF,0xFF,0xFF}, {0xCC,0xEA,0xFF}, {0xDE,0xE2,0xFF}, {0xEE,0xDA,0xFF},
  {0xFA,0xD7,0xFD}, {0xFD,0xD7,0xF6}, {0xFD,0xDC,0xD0}, {0xFA,0xE8,0xB6},
  {0xF2,0xF1,0xA9}, {0xDB,0xFB,0xA9}, {0xCA,0xFF,0xBD}, {0xC3,0xFB,0xD8},
...
void retro_set_environment(retro_environment_t cb)
{
   ...
   static const struct retro_variable vars[] = {
      ...
      { "nestopia_palette", "Palette; consumer|canonical|alternative|rgb|cxa2025as|pal|composite-direct-fbx|pvm-style-fbx|original-hardware-fbx|nes-classic-fbx-fs|raw|custom" },
...
static void check_variables(void)
{
   ...
   if (environ_cb(RETRO_ENVIRONMENT_GET_VARIABLE, &var))
   {
      ...
      else if (strcmp(var.value, "pvm-style-fbx") == 0) {
         video.GetPalette().SetMode(Api::Video::Palette::MODE_CUSTOM);
         video.GetPalette().SetCustom(pvm_style_fbx_palette, Api::Video::Palette::STD_PALETTE);
      }
      else if (strcmp(var.value, "original-hardware-fbx") == 0) {
         video.GetPalette().SetMode(Api::Video::Palette::MODE_CUSTOM);
         video.GetPalette().SetCustom(original_hardware_fbx_palette, Api::Video::Palette::STD_PALETTE);
      }
