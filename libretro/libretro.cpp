...
static const byte unsaturated_v5_palette[64][3] =
{
...
void retro_set_environment(retro_environment_t cb)
{
   ...
   static const struct retro_variable vars[] = {
      ...
      { "nestopia_palette", "Palette; consumer|canonical|alternative|rgb|yuv-v3|unsaturated-v5|raw" },
...
static void check_variables(void)
{
   ...
   if (environ_cb(RETRO_ENVIRONMENT_GET_VARIABLE, &var))
   {
      ...
      else if (strcmp(var.value, "unsaturated-v5") == 0) {
         video.GetPalette().SetMode(Api::Video::Palette::MODE_CUSTOM);
         video.GetPalette().SetCustom(unsaturated_v5_palette, Api::Video::Palette::STD_PALETTE);
      }
