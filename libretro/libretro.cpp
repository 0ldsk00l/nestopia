...
void retro_set_environment(retro_environment_t cb)
{
   ...
   static const struct retro_variable vars[] = {
      ...
      { "nestopia_palette", "Palette; consumer|canonical|alternative|rgb|cxa2025as|pal|composite-direct-fbx|pvm-style-fbx|ntsc-hardware-fbx|nes-classic-fbx-fs|raw|custom" },
